...
- [Azure Reservations](/azure/cost-management-billing/reservations/save-compute-costs-reservations) can help you save money by committing to one-year or three-year plans for several products, such as the VMs in your AKS cluster. You get discounts by reserving capacity. Use Azure Reservations for [Storage](/azure/storage/files/files-reserve-capacity) and [Compute](https://azure.microsoft.com/pricing/reserved-vm-instances) to reduce the cost of agent nodes. If you are working with multiple node pools, you can even [associate them to capacity reservation groups](/azure/aks/use-multiple-node-pools#associate-capacity-reservation-groups-to-node-pools-preview) created prior to ensure guaranteed capacity is allocated for your node pools as your application grows.
